 ...
 * <p>
 * Used to test various methods inside the BookorderJpaController class. This
...
public class BookorderJpaControllerTest {
    ...
    /**
     * Used to run valid tests for the getTotalSalesForBook method inside of the
     * BookorderJpaController class.
     *
     * @author Jean Robatto
     */
    ...
    /**
     * Used to run valid tests for the getTotalSalesForOrderPreTax method inside
     * of the BookorderJpaController class.
     *
     * @author Jean Robatto
     */
    ...
    /**
     * Used to run valid tests for the getHSTForOrder method inside of the
     * BookorderJpaController class.
     *
     * @author Jean Robatto
     */
    ...
    /**
     * Used to run valid tests for the getPSTForOrder method inside of the
     * BookorderJpaController class.
     *
     * @author Jean Robatto
     */
    ...
    /**
     * Used to run valid tests for the getGSTForOrder method inside of the
     * BookorderJpaController class.
     *
     * @author Jean Robatto
     */
