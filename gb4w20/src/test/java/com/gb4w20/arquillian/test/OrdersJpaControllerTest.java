 ...
 * <p>
 * Used to test various methods inside the OrdersJpaController class. 
...
public class OrdersJpaControllerTest {
    ...
    /**
     * Used to run valid tests for the getTotalSales 
     * method inside of the OrdersJpaController class. 
     * @author Jean Robatto
     */
    public static class GetTotalSales extends ArquillianTestBase {
     ...
     /**
     * Used to run valid tests for the getPurchasedBooks 
     * method inside of the OrdersJpaController class. 
     * @author Jean Robatto
     */
    public static class GetPurchasedBooks extends ArquillianTestBase {
        ...
        /**
         * Used to test if the book information given is equals to
         * the expected info from a specific order
         * @author Jean Robatto
         */
        @Test
