...
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 1, 9781401323585, 10, 13, null, null, true );
...
insert into orders(order_id, user_id, billing_address) VALUES( 3, 2, '456 avenue boulevard');
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 3, 9780000000000, 17, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 3, 9781401323585, 10, 13, null, null, false );
...
insert into reviews(user_id, isbn, rating, review, approved_status) VALUES( 2, 9780765377067, 4, 'The Three-Body Problem: test review by Jane' , true );
