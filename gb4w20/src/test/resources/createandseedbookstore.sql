/**
 * This file is to be used to make testing easier. 
 * 
 * Author:  Yasseen, Jeffrey
 */
...
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 2, 9780316251303, 16, null, 5, 9.975, false );
insert into orders(order_id, user_id, billing_address) VALUES( 3, 1, "123 road avenue");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 3, 9781612620244, 18, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 3, 9780345470584, 14, 13, null, null, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 3, 9781421527550, 18, null, 5, 6, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 3, 9780143039976, 14, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 3, 9780316080842, 20, null, 5, 9.975, true );
insert into orders(order_id, user_id, billing_address) VALUES( 4, 1, "123 road avenue");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 4, 9781542040358, 14, null, 5, 6, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 4, 9780000000008, 16, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 4, 9780316079914, 12, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 4, 9781421506234, 16, null, 5, 9.975, true );
insert into orders(order_id, user_id, billing_address) VALUES( 5, 1, "123 road avenue");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 5, 9780765326379, 10, null, 5, 6, false );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 5, 9781569319475, 19, null, 5, 6, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 5, 9780345470577, 17, 13, null, null, true );

insert into orders(order_id, user_id, billing_address) VALUES( 6, 2, "456 avenue boulevard");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 6, 9782253147695, 16, 13, null, null, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 6, 9781524745141, 15, null, 5, 6, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 6, 9780553803709, 18, 13, null, null, true );
...
insert into orders(order_id, user_id, billing_address) VALUES( 7, 2, "456 avenue boulevard");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 7, 9781250066213, 12, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 7, 9781591169208, 16, 13, null, null, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 7, 9780000000015, 16, null, 5, 9.975, true );
insert into orders(order_id, user_id, billing_address) VALUES( 8, 2, "456 avenue boulevard");
...
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 8, 9781427814036, 19, null, 5, 6, true );
insert into orders(order_id, user_id, billing_address) VALUES( 9, 2, "456 avenue boulevard");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 9, 9781591162209, 14, 13, null, null, false );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 9, 9781501190100, 15, null, 5, 6, false );
...
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 9, 9780812550702, 16, 13, null, null, true );
insert into orders(order_id, user_id, billing_address) VALUES( 10, 2, "456 avenue boulevard");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 10, 9780385333849, 20, null, 5, 6, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 10, 9780804139021, 14, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 10, 9781476727653, 10, 13, null, null, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 10, 9781612620244, 18, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 10, 9781250120922, 14, null, 5, 9.975, true );
insert into orders(order_id, user_id, billing_address) VALUES( 11, 2, "456 avenue boulevard");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 11, 9781421505855, 18, null, 5, 9.975, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 11, 9781250133731, 14, 13, null, null, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 11, 9780000000001, 14, 13, null, null, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 11, 9781413903171, 18, null, 5, 6, true );
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 11, 9780000000011, 18, 13, null, null, true );
insert into orders(order_id, user_id, billing_address) VALUES( 12, 2, "456 avenue boulevard");
insert into bookorder(order_id, isbn, amount_paid_pretax, HST_TAX, PST_TAX, GST_TAX, enabled) VALUES( 12, 9781892213013, 12, 13, null, null, false );
...
insert into book_files(file_format_id, isbn, file_location) VALUES(1, 9780765377104, "./Deaths_End.epub");
...
insert into book_files(file_format_id, isbn, file_location) VALUES(1, 9781591169154, "./Ouran_High_School_Host_Club_Vol_1.epub");
...
insert into book_files(file_format_id, isbn, file_location) VALUES(1, 9780450031069, "./Salems_Lot.epub");
...
insert into book_files(file_format_id, isbn, file_location) VALUES(1, 9781250120922, "./The_MotherinLaw.epub");
